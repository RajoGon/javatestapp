...
$lastRgDeployment = Get-AzureRmResourceGroup -ResourceGroupName $ResourceGroupName |
...
$query = “INSERT INTO dbo.ResourceGroups(ResourceGroupName,ResourceGroupid,Location,Tags,DeploymentStatus) VALUES ('$ResourceGroupName','$id','$location','$tags','$state')”
$sqlcmd.CommandText = $query
$InsertedID = $sqlcmd.executenonquery()
"Inserted row ID $InsertedID for file. " 
